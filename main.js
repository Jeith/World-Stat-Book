...
=======
        e.preventDefault();  
        var $rawCountry = $searchbar.val();
        var cc;
        localStorage.setItem('searchResult', $rawCountry)
        var $country = $rawCountry;
        switch($country){
>>>>>>> master
            case "aruba":
                cc = "aa";
...
<<<<<<< HEAD
        ...
        if (cc != null){
            ...
            var countryArray = ['AF','AL','AS','AO','AQ','AG','AR','AM','AU','BH','BD','BB','BY','BE','BM','BT','BO','BA','BR','IO','BN','BG','BF','CM','CA','CV','CF','TD','CN','CR','HR','CU','CY','CD','DJ','DO','EC','EG','GQ','ER','EE','ET','FO','FJ','FR','GA','GM','GH','GI','GR','GL','RO','RW','BL','KN','PM','VC','WS','SM','ST','SA','SN','SC','SL','SG','SI','SO','ZA','KR','ES','SZ','SE','CH','SY','TW','TZ','TH','TK','TO','TT','TN','TV','UG','AE','GB','US','UY','UZ','VE']
...
=======
    ...
    // this code runs after the search
    var $rawCountry = localStorage.getItem('searchResult')
    function loadSearchResults(){
        var $country = $rawCountry.toLowerCase();
        var cc;
        switch($country){
            case "aruba":
                cc = "aa";
        ...
        function updateUISuccess(response){
            //this function converts strings so that the first letter and every letter after a space capitalizes
            ...
            countryName.innerHTML = capitalLetter($rawCountry);
            var countryBackground = document.getElementById("countryBackground");
            countryBackground.innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;' + response.Introduction.Background.text;
            //this block declares all the variables needed for the age structure chart
            var ctx = document.getElementById("chart1");
            var agegroup1 = response["People and Society"]["Age structure"]["0-14 years"].text;
            var agegroup2 = response["People and Society"]["Age structure"]["15-24 years"].text;
            var agegroup3 = response["People and Society"]["Age structure"]["25-54 years"].text;
            ...
            function showGeography(){
                var countrybg = document.getElementById("countryBackgroundDiv");
                countrybg.setAttribute("style", "display: none;");
                var peopleCharts = document.getElementById("peopleCharts");
                peopleCharts.setAttribute("style", "display: none;");
            }

            function showPeopleAndSociety(){
                var countrybg = document.getElementById("countryBackgroundDiv");
                countrybg.setAttribute("style", "display: none;");
                var peopleCharts = document.getElementById("peopleCharts");
                peopleCharts.setAttribute("style", "display: block;");
            }
            ...
            function clickLinks(){
                ...
                peopleAndSociety.addEventListener('click', function() {
                    showPeopleAndSociety();
                  })
                government.addEventListener('click', function() {
                    showGovernment();
                  })
